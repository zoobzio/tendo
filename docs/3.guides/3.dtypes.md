...
| BFloat16 | 16 | 8 | 7 | ~1e-38 to ~3e38 | Large dynamic range inference |
...
- Better for large values: maintains dynamic range

### Use Cases

- Inference with reduced memory
- When dynamic range matters more than precision
- Loading models trained in BFloat16
