module github.com/zoobzio/tendo/examples

go 1.25.0

require (
	github.com/zoobzio/tendo/cpu v0.0.0
	github.com/zoobzio/tendo/cuda v0.0.0
	github.com/zoobzio/tendo/models v0.0.0
)
...
require (
	...
	github.com/zoobzio/tendo v0.0.0 // indirect
	github.com/zoobzio/tendo/nn v0.0.0 // indirect
